...
SYS-6…SYS-23 PASS. Next eng candidates: customer merge/transfer UX, external-actions CRUD — or human product-owner UI sign-off (must not auto-PASS). Free-form drag deferred. Not claimed as full commercial. Tencent Cloud out of scope (G).
