...
SYS-6…SYS-8 PASS (role matrix, workflow versioning, cross-device Member resume). Next optional: visual workflow editor / product-owner UI sign-off. Not claimed as full commercial. Tencent Cloud out of scope (G).
