...
- last_safe_commit: pending SYS-8 commit
- verified_sys_8_member_resume: PASS - resume API revokes prior access + Consumer ????resume form proves membership. See PROJECT_STATE/SYS_8_MEMBER_RESUME_ACCEPTANCE.md.
