...
- hardening_006: IN PROGRESS. Server clean-image validation exposed two further required workspace packages (`@oneday/session-client`, `@oneday/ui`); the Docker dependency stage has been expanded and requires a fresh verification. Evidence: `evidence/HARDENING-006/ACCEPTANCE.md`.
