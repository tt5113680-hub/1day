...
- next_scope: Product-owner UI sign-off on localhost HUMAN-PILOT; optional scoped matrix P1 after human decision. Still no page-level patches. Not a public 全部商用 claim without human pilot. Tencent Cloud out of scope (G).
