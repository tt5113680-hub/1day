...
- last_completed_task: SYS-16 Linear flow JSON export PASS
...
- last_safe_commit: PENDING_SYS16
- verified_sys_16_linear_flow_export: PASS - honest linear JSON export (not free-form graph). See PROJECT_STATE/SYS_16_LINEAR_FLOW_EXPORT_ACCEPTANCE.md.
