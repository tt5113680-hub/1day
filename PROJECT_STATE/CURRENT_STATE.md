...
- verified_hardening_006: PASS. Docker workspace dependencies are built before API/Worker/HUMAN-PILOT targets; 18-package typecheck and a clean human-pilot image build passed. Evidence: `evidence/HARDENING-006/ACCEPTANCE.md`.
