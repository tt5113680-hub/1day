...
- hardening_006: IN PROGRESS. Server clean-image validation exposed further required workspace packages, including `@oneday/database` for migrations; the Docker dependency stage has been expanded and requires a fresh verification. Evidence: `evidence/HARDENING-006/ACCEPTANCE.md`.
