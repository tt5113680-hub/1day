...
- verified_sys_19_start_context_presets: PASS - STA start-context presets for path simulator (not free-form graph). See PROJECT_STATE/SYS_19_START_CONTEXT_PRESETS_ACCEPTANCE.md.
