...
- verified_hardening_006: PASS. Docker builds Auth, Events, Database, Session Client and UI before dependent app targets. A clean Tencent Cloud human-pilot image build, migrations 001-047, local proxy health and external IP health/home checks passed. Evidence: `evidence/HARDENING-006/ACCEPTANCE.md`.
