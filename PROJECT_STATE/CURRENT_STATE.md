...
- verified_sys_6_role_matrix_network: PASS - Channel/Circle/Platform packages separated via channel.read/manage + scopes; platform tenants/suspend denied to channel/circle-only. See PROJECT_STATE/SYS_6_ROLE_MATRIX_NETWORK_ACCEPTANCE.md.
