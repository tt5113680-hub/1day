...
## 2. 大厂对标与系统身份（团购推广员工具 · 2026-08-11）

**权威细则：** `PROJECT_STATE/PRODUCT_DUAL_TRACK_STRATEGY.md`

| 项 | 裁决 |
| -- | ---- |
| 身份 | **推广员工具**：统一入口、统一整合生态、统一工作流；助力第三方，不竞争 |
| 禁止 | **不碰钱、不碰销售、不碰管理**；成交/收银走美团抖音扫呗等第三方 |
| 自营入口 | 第三方；首选 **扫呗小程序 + 收银** |
| 附近 | 全平台「全平台可见引流」开通商家；UI 学外卖 LBS 首页 |
| 商圈 | 单独页；自建/管理 + 看附近圈；经理邀约 / 商家申请 |
| 痕迹分析 | 仅观看/访问/跳转/停留/分享；模块命名 + 行业模板/自助/AI |
| 首页 | 微站=官网=消费者首页（同页不同模板样式） |
| UI | 套用成熟习惯，不另造管理系统；美团黄可换肤 |
| 开发节奏 | 先过身份过滤器再开工；禁止假接实时库存价格当自营商城 |

**不做进第一阶段：** 九角色全包、任意 HTML 低代码、假 BI、宣称已接美团实时库存、本平台收款成交。  
**本阶段必须纠正：** 平台/渠道扁平向导 → 省市区代理树开通；能力叙事改为「入口/整合/工作流/痕迹」而非「管店卖货」。
