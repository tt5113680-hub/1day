...
- Public TEST ONLY preview was rebuilt and verified at `http://49.232.124.130:18080/c/services/30000000-0000-4000-8000-000000000850?tenant=luckin-oneday-human-pilot&source=consumer%3Astorefront` on release `64ce975`: the live page rendered Meituan `¥19.90`, Douyin `¥21.90`, partner `¥20.90`, product details, purchase notes, store hours and the Meituan purchase action. The isolated API/Worker/Consumer containers all passed health/startup checks.
