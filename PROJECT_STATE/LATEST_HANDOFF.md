...
- HEAD (pushed): tip after SYS-17 state commit
- last_safe_commit: PENDING_SYS17_COMMIT
...
3. SYS-17 STA insert rails (this commit)
...
状态：SYS-17 PASS（safe 见 LATEST_HANDOFF）；P0 26/26；工作区干净。
