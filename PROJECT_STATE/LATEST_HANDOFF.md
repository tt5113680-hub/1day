...
- HEAD (pushed): tip after state commit; safe feature PENDING_SYS15
- last_safe_commit: PENDING_SYS15_COMMIT
...
1. SYS-15 Version panel linear reorder — ↑↓ + clone-publish order via existing APIs
