...
- HEAD (pushed): tip TBD after SYS-28 commits
- last_safe_commit: TBD (SYS-28 feature commit)
...
2. SYS-28 Platform channel/circle-only shell isolation
...
Status: SYS-28 PASS (safe COMMIT); P0 26/26; S3 chrome + shell isolation landed; clean tree.
