...
- HEAD (pushed): tip after state commit; safe feature `7f78e6b`
- last_safe_commit: 7f78e6b
...
1. SYS-14 Draft authoring preview (`7f78e6b`) — linear 上移/下移 + create-form live branch/path preview
...
状态：SYS-14 PASS（safe 7f78e6b）；P0 26/26；工作区干净。
