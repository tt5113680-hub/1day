...
- Base HEAD: `0bc1a0c`; all Platform core governance pages, the migrated Management operating views and the Employee workbench/task/lead-pool/notifications/nurture/profile surfaces now use the tokenized product foundation. Onboarding, template publication and connector authorization explicitly avoid falsely claiming Batch 2 commercial READY, Consumer Storefront activation or external delivery.
