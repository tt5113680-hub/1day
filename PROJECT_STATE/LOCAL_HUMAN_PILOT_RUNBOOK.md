...
消费者入口：`http://127.0.0.1:3201/c/entry?tenant=luckin-oneday-human-pilot`

本机服务：API `http://127.0.0.1:3200`、Worker `http://127.0.0.1:3205/health`、员工端 `http://127.0.0.1:3202/e/login`、管理端 `http://127.0.0.1:3203/login`、平台端 `http://127.0.0.1:3204/login`。

所有密码、租户标识和账号见 [LOCAL_HUMAN_PILOT_ACCOUNTS.md](LOCAL_HUMAN_PILOT_ACCOUNTS.md)。登录页先填“租户标识”，再填邮箱和统一本地测试密码。

## 1. 消费者进入瑞幸测试商户

- 打开：`http://127.0.0.1:3201/c/entry?tenant=luckin-oneday-human-pilot`
- 账号：不登录，保持匿名。
...
- 打开：`http://127.0.0.1:3201/c/discovery?tenant=luckin-oneday-human-pilot&latitude=39.9087&longitude=116.4619`
- 账号：不登录。
...
- 打开：第 2 步的北京国贸测试店，或直接打开 `http://127.0.0.1:3201/c/stores/30000000-0000-4000-8000-000000000021?tenant=luckin-oneday-human-pilot`。
- 账号：不登录。
...
- 打开：`http://127.0.0.1:3202/e/login`
...
- 打开：员工端 `http://127.0.0.1:3202/e/login` 和管理端 `http://127.0.0.1:3203/login`。
