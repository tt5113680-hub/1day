...
- Employee Lead Pool page-local header, recovery/form/card/button/status styling is deprecated at `aeaf454`; claim, allocation, conversion, optimistic-version and idempotency behavior remain tenant-scoped.
