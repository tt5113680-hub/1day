...
- [x] HARDENING-006 PASS - Docker workspace dependency build order repaired for API, Worker and human-pilot image targets. Clean Tencent Cloud image build, migrations 001-047, proxy health and external IP health/home checks passed. Evidence: `evidence/HARDENING-006/ACCEPTANCE.md`.
