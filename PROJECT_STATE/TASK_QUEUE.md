...
- [ ] G1 OWNER GATE — owner runs `pnpm human-pilot:start` (services up on 3200–3205), walks `docs/HUMAN_PILOT_MANUAL_TEST.md`, completes `docs/PILOT_ACCEPTANCE_CHECKLIST.md`, and signs `PROJECT_STATE/PRODUCT_OWNER_UI_ACCEPTANCE.md`. P1-C live then blocked on owner lifting G + cloud inventory (`PHASE1_COMMERCIAL_CLOSED_LOOP_PLAN.md` §2).
