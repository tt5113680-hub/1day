...
- [ ] HARDENING-006 IN PROGRESS - Docker workspace dependency build order is being repaired for API, Worker and human-pilot image targets. Server clean-image validation exposed required Session Client, UI and Database builds; a fresh image/migration verification is pending. Evidence: `evidence/HARDENING-006/ACCEPTANCE.md`.
