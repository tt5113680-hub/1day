...
- [ ] SYS-18 Structured Timeline Authoring — condition card IA (see `WORKFLOW_AUTHORING_UX_RECOMMENDATION.md`).
- [ ] SYS-19 Structured Timeline Authoring — start-context presets for path simulator.
