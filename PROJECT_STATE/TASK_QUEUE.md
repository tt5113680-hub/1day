...
- [ ] **NEXT:** **W∞-77** 消费者 `one-code/[code]` 一码落地 / `share/[code]` 分享落地 / `processes/[id]` 服务过程 / `services/[id]` / store 子页（group-buy/menu/membership/profile）真实数据深页 densify，或平台/员工剩余 PARTIAL densify。
